    ...
    <div id="header-topbar-option-demo" class="page-header-topbar">
        <nav id="topbar" role="navigation" style="margin-bottom: 0; z-index: 2;"
            ...
            <div class="navbar-header">
                ...
                <a id="logo" href="<?php echo _APPLICACION_URL?>" class="navbar-brand"><!--img src="http://localhost/cityzeen/template/app/images/gallery/cityzeenlogo.jpeg" alt="cityzeen" height="auto" width="100%" /--></a>
            </div>
