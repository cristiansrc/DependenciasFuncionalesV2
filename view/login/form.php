...
<div class="page-form">
    <form action="<?php echo _APPLICACION_URL?>login/initSession.html" id="login" class="form-validate-signin" novalidate="novalidate" method="POST">
        <div class="header-content"><img src="http://localhost/cityzeen/template/app/images/gallery/cityzeenlogo.jpeg" alt="cityzeen" height="auto" width="100%" /><!--h1>Ingreso</h1--></div>
